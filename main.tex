%Si la línea de investigación es SIG
\documentclass[artMGITG,SIG,accept,moreauthors,font4]{mgitg}
%Si la línea de investigación es IDE
%\documentclass[artMGITG,IDE,accept,moreauthors,font4]{mgitg}
%Si la línea de investigación es PR
%\documentclass[artMGITG,PR,accept,moreauthors,font4]{mgitg}
...
% \usepackage{graphicx}
% Puede incluir los packages que necesite
...
%-- AGRADECIMIENTOS ------------------------
% Si quiere presentar agradecimientos, debe quitar el comentario en la siguiente línea
%\acknowledgments{}

%-- REFERENCIAS ------------------------
\reftitle{Referencias}
% Las referencias usadas en el documento se deben estar en en el archivo 'referencias.bib'. Si su archivo .bib tiene otro nombre, debe usar ese nombre en '\bibliography{}'
\bibliography{referencias}

%-- APÉNDICES ------------------------
% Si su documento tiene información adicional, la cual se debe inlcuir en un apéndice, lo puede hacer aquí. Si no lo necesita, puede poner en comentarios las siguientes líneas, o bien eliminarlas.
%\appendixtitles{yes} 
\appendix   % De aquí para adelante todas las secciones son consideradas como apéndices
